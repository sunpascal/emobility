...
public class EcoDrivingTechniqueAdapter extends ArrayAdapter<EcoDrivingProgress> {
  private final Context context;
  private final EcoDrivingProgress[] values;

  public EcoDrivingTechniqueAdapter(Context context, EcoDrivingProgress[] values2) {
