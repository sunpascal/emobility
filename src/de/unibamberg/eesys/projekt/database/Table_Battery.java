...
/**
* The Table_Battery class is used to define the name and columns
...
public class Table_Battery {
	...
	public static final String COLUMN_CURRENT_SOC = "currentSoc";
	public static final String COLUMN_CHARGING = "charging";
	
	public static final String FULL_ID = TABLE_NAME + "." + COLUMN_ID;
	
	// create and drop statements
	private static final String TABLE_CREATE = "CREATE TABLE " + Table_Battery.TABLE_NAME + "( " + Table_Battery.COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Table_Battery.COLUMN_CURRENT_SOC + " REAL, " + Table_Battery.COLUMN_CHARGING + "  INTEGER );";
	private static final String TABLE_DROP = "DROP TABLE IF EXISTS " + Table_Battery.TABLE_NAME + ";";

 	/**
	 * Creates the database table "Battery" during the application start.
	...
	public static void onCreate( final SQLiteDatabase db ) {
		db.execSQL( Table_Battery.TABLE_CREATE );
	...
	/**
	 * Upgrades the database table "Battery" during the application start.
	 * Used by DBInitializer.
	 * 
	 * @param db: SQLiteDatabase object
	...
	public static void onUpgrade( final SQLiteDatabase db, final int oldVersion, final int newVersion ) {
		...
		db.execSQL( Table_Battery.TABLE_DROP );
	...
	/**
	 * Downgrades the database table "Battery" during the application start.
	 * Used by DBInitializer.
	 * 
	 * @param db: SQLiteDatabase object
	 * @param oldVersion: number (int) of the old database version
	...
	public static void bulkInsert( final SQLiteDatabase db ) {
        ...
        args.put(COLUMN_CURRENT_SOC, 22);
        args.put(COLUMN_CHARGING, false);
        cvBulk.add(args);
